...
- 0.17 loyalty + rival personality: loyalty moves on death/incidents/rest/wins with resignation at zero (frees hiring, logged, unassignable); aggressive/wildcard rivals pounce on expiring offers first; publishers pay +1 prestige per confirmation; steady rivals shrug sabotage (0.75x). All suites green.
