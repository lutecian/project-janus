...
- Strategy: 8 acquirable companies (noisy pricing, due diligence, steal/fair/lemon, subsidiaries, hostile bids), 24 facilities in 3 tiers (+6 prize rooms), espionage (5 ops incl. sabotage-sweeping counter-intel, Risk/Cover, caught consequences; poaching exists as ex-rival hiring backgrounds), 25 contracts (upfront + workdays + tech), 18 world events, loans ($2k/$5k/$10k, 2%/day, overdue collectors)
