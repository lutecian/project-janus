...
func _run_all():
	_probe_batch("expert-batch", "expert", 300, true)
	_probe_batch("expert-batch-b", "expert", 301, true)
	_probe_batch("expert-batch-c", "expert", 302, true)
	_probe("easy-pure", "easy", 100, false, false, false)
	_probe("normal-pure", "normal", 1234, false, false, false)
	_probe("normal-pure-b", "normal", 5555, false, false, false)
	_probe("normal-pure-c", "normal", 9000, false, false, false)
	_probe("hard-pure", "hard", 200, false, false, false)
	_probe("hard-pure-b", "hard", 201, false, false, false)
	_probe("normal-contracts", "normal", 1234, true, false, false)
	_probe("normal-systems", "normal", 1234, true, true, false)
	_probe("normal-systems-b", "normal", 5555, true, true, false)
	_probe("normal-systems-c", "normal", 9000, true, true, false)
